...
class Tetris():
    ...
    def step(self, action):
        ...
        print(self.need_to_lock(self.current_piece, self.grid))
    ...
    def need_to_lock(self, current_piece, grid):
        ...
        # TODO: check if no empty space below these any block of piece
        # get all different columns
        at_start = False

        for pos in piece_positions:
            at_start = at_start or pos[0]<1

        if piece_positions is None or at_start:
            return
