...
def inv_var_optimization():
    ...
    for i in range(epochs):
        ...
        if(i%300==0):
            inv_var_params.append(params.copy())
    
    return inv_var_params


inc_var_params1 = inv_var_optimization()

string = ""
for _params in inc_var_params1:
    string = string + str(_params[0])+" "+str(_params[1])+"\n"

text_file = open("inc_params1.txt", "w")
n = text_file.write(string)
text_file.close()


inc_var_params2 = inv_var_optimization()

string = ""
for _params in inc_var_params2:
    string = string + str(_params[0])+" "+str(_params[1])+"\n"

text_file = open("inc_params2.txt", "w")
n = text_file.write(string)
text_file.close()



inc_var_params3 = inv_var_optimization()

string = ""
for _params in inc_var_params3:
    string = string + str(_params[0])+" "+str(_params[1])+"\n"

text_file = open("inc_params3.txt", "w")
n = text_file.write(string)
text_file.close()



inc_var_params4 = inv_var_optimization()

string = ""
for _params in inc_var_params4:
    string = string + str(_params[0])+" "+str(_params[1])+"\n"

text_file = open("inc_params4.txt", "w")
n = text_file.write(string)
text_file.close()



inc_var_params5 = inv_var_optimization()

string = ""
for _params in inc_var_params5:
    string = string + str(_params[0])+" "+str(_params[1])+"\n"

text_file = open("inc_params5.txt", "w")
n = text_file.write(string)
text_file.close()